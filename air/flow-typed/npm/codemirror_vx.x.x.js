// flow-typed signature: 578a09069f44725dee6c00c4f644efd9
// flow-typed version: <<STUB>>/codemirror_v5.58.1

/**
 * Note: this has been autogenerated and then edited to make the build pass.
 * It is not a good typing module for the full codemirror API.
 */

declare module "codemirror" {
  declare export default typeof CodeMirror;
  declare var CodeMirror: typeof npm$namespace$CodeMirror;

  declare var npm$namespace$CodeMirror: {|
    (host: HTMLElement, options?: EditorConfiguration): Editor,
    (
      callback: (host: HTMLElement) => void,
      options?: EditorConfiguration
    ): Editor,
    countColumn: typeof countColumn,
    fromTextArea: typeof fromTextArea,
    splitLines: typeof splitLines,
    isWordChar: typeof isWordChar,
    startState: typeof startState,
    cmpPos: typeof cmpPos,
    changeEnd: typeof changeEnd,
    defineExtension: typeof defineExtension,
    defineDocExtension: typeof defineDocExtension,
    defineOption: typeof defineOption,
    defineInitHook: typeof defineInitHook,
    registerHelper: typeof registerHelper,
    innerMode: typeof innerMode,
    extendMode: typeof extendMode,
    on: typeof on,
    off: typeof off,
    signal: typeof signal,
    normalizeKeyMap: typeof normalizeKeyMap,
    defineMode: typeof defineMode,
    getMode: typeof getMode,
    overlayMode: typeof overlayMode,
    ...
    modes: typeof modes,
    mimeModes: typeof mimeModes,
    commands: typeof commands,
  |};
  // declare export var Doc: DocConstructor;

  declare export var Pos: PositionConstructor;

  declare export var Pass: {
   ...
   */
  declare function splitLines(text: string): Array<string>;

  /**
   * Check if a char is part of an alphabet.
   */
  declare function isWordChar(ch: string): boolean;

  /**
   * Call startState of the mode if available, otherwise return true
   */
  declare function startState(
    mode: Mode<any>,
    a1?: any,
    a2?: any
  ): any | boolean;
   ...
   */
  declare function cmpPos(a: Position, b: Position): number;
   ...
   */
  declare function changeEnd(change: EditorChange): Position;
   ...
   */
  declare function registerHelper(
    namespace: string,
    name: string,
    helper: any
  ): void;
   ...
   */
  declare function extendMode(name: string, properties: Mode<any>): void;
  ...
  declare function on(
    ...
    handler: (instance: Editor, obj: EditorSelectionChange) => void
  ): void;
   ...
   */
  declare function normalizeKeyMap(km: KeyMap): KeyMap;
  ...
  declare type CoordsMode = "window" | "page" | "local" | "div";
  ...
  declare export type Editor = {
    showHint({ hint: (Editor) => {| from: any, list: any, to: any |} }): void,
    /**
     ...
     */
    setOption<K: $Keys<EditorConfiguration>>(
      option: K,
      value: $ElementType<EditorConfiguration, K>
    ): void,

    /**
     * Retrieves the current value of the given option for this editor instance.
     */
    getOption<K: $Keys<EditorConfiguration>>(
      option: K
    ): $ElementType<EditorConfiguration, K>,
     ...
     */
    scrollIntoView(pos: Position | null, margin?: number): void,
    ...
    on(
      eventName: "change",
      handler: (instance: Editor, changeObj: EditorChangeLinkedList) => void
    ): void,
    off(
      eventName: "change",
      handler: (instance: Editor, changeObj: EditorChangeLinkedList) => void
    ...
    on(
      eventName: "changes",
      handler: (instance: Editor, changes: EditorChangeLinkedList[]) => void
    ): void,
    off(
      eventName: "changes",
      handler: (instance: Editor, changes: EditorChangeLinkedList[]) => void
    ...
    on(
      eventName: "beforeChange",
      handler: (instance: Editor, changeObj: EditorChangeCancellable) => void
    ): void,
    off(
      eventName: "beforeChange",
      handler: (instance: Editor, changeObj: EditorChangeCancellable) => void
     ...
     */
    on(eventName: "cursorActivity", handler: (instance: Editor) => void): void,
    off(eventName: "cursorActivity", handler: (instance: Editor) => void): void,
    ...
    on(
      ...
      handler: (instance: Editor, name: string, event: KeyboardEvent) => void
    ): void,
    off(
      eventName: "keyHandled",
      handler: (instance: Editor, name: string, event: KeyboardEvent) => void
    ...
    on(
      eventName: "inputRead",
      handler: (instance: Editor, changeObj: EditorChange) => void
    ): void,
    off(
      eventName: "inputRead",
      handler: (instance: Editor, changeObj: EditorChange) => void
    ...
    on(
      ...
      handler: (instance: Editor, line: number) => void
    ): void,
    off(
      eventName: "electricInput",
      handler: (instance: Editor, line: number) => void
    ...
    on(
      ...
      handler: (instance: Editor, from: number, to: number) => void
    ): void,
    off(
      eventName: "viewportChange",
      handler: (instance: Editor, from: number, to: number) => void
    ...
    on(
      eventName: "swapDoc",
      handler: (instance: Editor, oldDoc: Doc) => void
    ): void,
    off(
      eventName: "swapDoc",
      handler: (instance: Editor, oldDoc: Doc) => void
    ...
    on(
      eventName: "focus",
      handler: (instance: Editor, event: FocusEvent) => void
    ): void,
    off(
      eventName: "focus",
      handler: (instance: Editor, event: FocusEvent) => void
     ...
     */
    on(eventName: "scroll", handler: (instance: Editor) => void): void,
    off(eventName: "scroll", handler: (instance: Editor) => void): void,
     ...
     */
    on(eventName: "refresh", handler: (instance: Editor) => void): void,
    off(eventName: "refresh", handler: (instance: Editor) => void): void,
    ...
    on(
      ...
      handler: (instance: Editor, option: string) => void
    ): void,
    off(
      eventName: "optionChange",
      handler: (instance: Editor, option: string) => void
    ...
    on(
      ...
      handler: (instance: Editor, event: Event) => void
    ): void,
    off(
      eventName: "scrollCursorIntoView",
      handler: (instance: Editor, event: Event) => void
     ...
     */
    on(eventName: "update", handler: (instance: Editor) => void): void,
    off(eventName: "update", handler: (instance: Editor) => void): void,
     ...
     */
    on<K: DOMEvent & $Keys<GlobalEventHandlersEventMap>>(
      eventName: K,
      handler: (
        instance: Editor,
        event: $ElementType<GlobalEventHandlersEventMap, K>
      ) => void
    ): void,
    off<K: DOMEvent & $Keys<GlobalEventHandlersEventMap>>(
      eventName: K,
      handler: (
        instance: Editor,
        event: $ElementType<GlobalEventHandlersEventMap, K>
     ...
     */
    on<K: DOMEvent & $Keys<DocumentAndElementEventHandlersEventMap>>(
      eventName: K,
      handler: (
        instance: Editor,
        event: $ElementType<DocumentAndElementEventHandlersEventMap, K>
      ) => void
    ): void,
    off<K: DOMEvent & $Keys<DocumentAndElementEventHandlersEventMap>>(
      eventName: K,
      handler: (
        instance: Editor,
        event: $ElementType<DocumentAndElementEventHandlersEventMap, K>
    ...
    on(
      ...
      handler: (instance: Editor, overwrite: boolean) => void
    ): void,
    ...
    off(eventName: string, handler: (instance: Editor) => void): void,
  ...
  declare type EditorFromTextArea = {
    /**
  ...
  declare interface LineWidgetOptions {
    /**
  ...
  declare export interface EditorChange {
    /**
  ...
  declare type EditorChangeLinkedList = {
    /**
  ...
  declare type EditorChangeCancellable = {
    /**
  ...
  declare interface EditorSelectionChange {
    ranges: Range[];
  ...
  declare type InputStyle = "textarea" | "contenteditable";
  ...
  declare interface StringStreamConstructor {
    new(text: string): StringStream;
  }

  declare type StringStream = {
   ...
   */
  declare function getMode<T>(config: EditorConfiguration, mode: any): Mode<T>;
   ...
   */
  declare function overlayMode<T, S>(
    base: Mode<T>,
    overlay: Mode<S>,
    combine?: boolean
  ): Mode<any>;

  declare interface ModeMap {
   ...
   */
  declare var modes: ModeMap;

  declare function defineMIME(mime: string, modeSpec: any): void;

  declare interface MimeModeMap {
    [mimeName: string]: any;
  }
   ...
   */
  declare var mimeModes: MimeModeMap;

  declare interface CommandActions {
    /**
   ...
   */
  declare var commands: CommandActions;
  ...
  declare var npm$namespace$MergeView: {|
    (
      element: HTMLElement,
