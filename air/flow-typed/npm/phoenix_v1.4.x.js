// flow-typed signature: fbdbee35537ce62d79670f9697b4d2ac
// flow-typed version: 19e5a5d33f/phoenix_v1.4.x/flow_>=v0.104.x
...
declare module "phoenix" {
  ...
  declare export class Channel {
    ...
    // Note: This is added post installation, as it is private, but our code depends on it!?
    isJoined(): boolean;
  }
  ...
  declare export type PresenceOnJoinCallback = (
    key?: string,
    currentPresence?: any,
    newPresence?: any
  ) => void;
  declare export type PresenceOnLeaveCallback = (
    key?: string,
    currentPresence?: any,
    newPresence?: any
  ) => void;
