defmodule Air.PsqlServer.Protocol.Authentication do
  ...
  def handle_raw_message(state, :initial, message) do
  ...
  def handle_raw_message(state, :ssl_negotiated, message) do
