defmodule Air.Service.Export do
  ...
  user's browser as a file download), so nothing needs to be cleaned up when deleting the user or purging the user's
  data during a Right to be Forgotten request.
