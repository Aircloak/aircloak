defmodule AirWeb.Admin.CentralController do
  ...
  def export(conn, params),
    do:
      ...
      |> render(
        oldest_pending_call_time: Central.oldest_pending_call_time(),
  ...
  defp send_attachment(conn, file_name, data),
    do:
      conn
  ...
  defp exports(params), do: Central.exports(String.to_integer(params["page"] || "1"), 10)
end
