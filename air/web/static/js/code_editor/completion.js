...
const KEYWORDS = [
  ...
  "SUM(numericalColumn)", "MIN(numericalColumn)", "MAX(numericalColumn)", "AVG(numericalColumn)",
  "STDDEV(numericalColumn)", "MEDIAN(numericalColumn)",
  "EXTRACT_MATCH(stringColumn, 'regex')", "EXTRACT_MATCHES(stringColumn, 'regex')",
  "YEAR(dateColumn)", "MONTH(dateColumn)", "DAY(dateColumn)",
  "ABS(numericalColumn)", "CEIL(numericalColumn)",
