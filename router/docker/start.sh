...
cp -rp /aircloak/router/docker/conf.d/upstreams.toml /etc/confd/conf.d/
...
confd -interval 10 -node 127.0.0.1:$ETCD_CLIENT_PORT -config-file /etc/confd/conf.d/upstreams.toml &
