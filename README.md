...
You need to have Erlang, Elixir, Rust, NodeJS, and yarn installed. The required versions are stated in [this file](.tool-versions).
...
[Elixir](https://github.com/asdf-vm/asdf-elixir), [Rust](https://github.com/code-lever/asdf-rust), [NodeJS](https://github.com/asdf-vm/asdf-nodejs), and [yarn](https://github.com/twuni/asdf-yarn) plugins.
