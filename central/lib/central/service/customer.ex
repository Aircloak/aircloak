defmodule Central.Service.Customer do
  ...
  def supervisor_spec() do
    ...
    supervisor(Task.Supervisor, [[name: @message_handler_sup]], id: @message_handler_sup)
  end

  @doc "Imports the data generated by the manual export."
  @spec import_customer_data(binary) :: {:ok, pos_integer} | {:error, AirMessage.import_error}
