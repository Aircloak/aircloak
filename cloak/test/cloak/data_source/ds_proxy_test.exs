    ...
    expect_json_post(context.bypass, "/query",
      fn(payload) ->
        ...
        assert %{"params" => [], "type" => "parsed", "val" =>
          ~S[SELECT "bar"."user_id","bar"."foo" FROM "bar" WHERE ("bar"."user_id" IS NOT NULL)]} == statement
  ...
  test "parsed select count(*)", context do
    expect_json_post(context.bypass, "/query",
      fn(payload) ->
        ...
        assert ~S[SELECT "bar"."user_id" FROM "bar" WHERE ("bar"."user_id" IS NOT NULL)] == query_string
    ...
    expect_json_post(context.bypass, "/query",
      fn(payload) ->
        ...
        assert %{
          "params" => [],
          "type" => "parsed",
          "val" => ~S[SELECT "bar"."user_id","bar"."foo","bar"."baz" FROM "bar" WHERE ("bar"."user_id" IS NOT NULL)]
        } == statement
