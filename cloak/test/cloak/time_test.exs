defmodule Cloak.Time.Test do
  ...
  test "parsing an invalid datetime", do:
    assert {:error, :invalid_format} = Cloak.Time.parse_datetime("invalid")

  test "parsing a full datetime", do:
    assert {:ok, ~N[2000-01-01 01:02:03.000000]} = Cloak.Time.parse_datetime("2000-01-01 01:02:03")
