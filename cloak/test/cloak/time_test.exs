defmodule Cloak.Time.Test do
  ...
  test "parsing an invalid date",
    do: assert({:error, :invalid_format} = Cloak.Time.parse_date("invalid"))
  ...
  test "parsing an invalid datetime",
    do: assert({:error, :invalid_format} = Cloak.Time.parse_datetime("invalid"))

  test "parsing a full datetime",
    do:
      assert(
        {:ok, ~N[2000-01-01 01:02:03.000000]} = Cloak.Time.parse_datetime("2000-01-01 01:02:03")
      )
  ...
  test "1583-01-01 is the minimum parseable datetime" do
    assert {:ok, ~N[1583-01-01 00:00:00.000000]} =
             Cloak.Time.parse_datetime("1583-01-01 00:00:00")
  ...
  test "9999-12-31 is the maximum parseable datetime" do
    assert {:ok, ~N[9999-12-31 23:59:59.999999]} =
             Cloak.Time.parse_datetime("9999-12-31 23:59:59.999999")
