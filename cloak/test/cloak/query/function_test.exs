defmodule Cloak.Query.FunctionTest do
  ...
  test "min(datetime)", do: assert_subquery_aggregate("min(datetime)", "datetimes_ft", "2015-02-03 04:05:06")
  test "max(datetime)", do: assert_subquery_aggregate("max(datetime)", "datetimes_ft", "2015-02-03 04:05:06")
  ...
  describe "date_trunc for datetime" do
    test "date_trunc('second')", do:
      assert "2015-02-03 04:05:06" == apply_function("date_trunc('second', datetime)", "datetimes_ft")
    test "date_trunc('minute')", do:
      assert "2015-02-03 04:05:00" == apply_function("date_trunc('minute', datetime)", "datetimes_ft")
    test "date_trunc('hour')", do:
      assert "2015-02-03 04:00:00" == apply_function("date_trunc('hour', datetime)", "datetimes_ft")
    test "date_trunc('day')", do:
      assert "2015-02-03 00:00:00" == apply_function("date_trunc('day', datetime)", "datetimes_ft")
    test "date_trunc('month')", do:
      assert "2015-02-01 00:00:00" == apply_function("date_trunc('month', datetime)", "datetimes_ft")
    test "date_trunc('quarter')", do:
      assert "2015-01-01 00:00:00" == apply_function("date_trunc('quarter', datetime)", "datetimes_ft")
    test "date_trunc('year')", do:
      assert "2015-01-01 00:00:00" == apply_function("date_trunc('year', datetime)", "datetimes_ft")
  end

  describe "date_trunc for time" do
    test "date_trunc('second')", do:
      assert "04:05:06" == apply_function("date_trunc('second', cast(datetime as time))", "datetimes_ft")
    test "date_trunc('minute')", do:
      assert "04:05:00" == apply_function("date_trunc('minute', cast(datetime as time))", "datetimes_ft")
    test "date_trunc('hour')", do:
      assert "04:00:00" == apply_function("date_trunc('hour', cast(datetime as time))", "datetimes_ft")
    test "date_trunc('day')", do:
      assert "00:00:00" == apply_function("date_trunc('day', cast(datetime as time))", "datetimes_ft")
    test "date_trunc('quarter')", do:
      assert "00:00:00" == apply_function("date_trunc('quarter', cast(datetime as time))", "datetimes_ft")
  end
