defmodule Cloak.Query.FunctionTest do
  ...
  test "ceiling", do: assert 181 == apply_function("ceiling(frac)", ["frac"], [180.1], "types_ft")
  ...
  test "lcase", do: assert "abc" == apply_function("lcase(string)", ["string"], ["AbC"], "types_ft")
  test "upper", do: assert "ABC" == apply_function("upper(string)", ["string"], ["AbC"], "types_ft")
  test "ucase", do: assert "ABC" == apply_function("ucase(string)", ["string"], ["AbC"], "types_ft")
