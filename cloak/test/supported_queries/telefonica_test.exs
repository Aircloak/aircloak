  ...
  defp contract_id_tables(),
    do: %{
      "DW.CC_CONTRACTS_DM" => [
        ...
        {"PRODUCT_ID_CURRENT", [type: :integer, key: :tf_product_id]},
      ...
      "DW.CC_PRODUCTS" => [
        ...
        {"PRODUCT_ID", [type: :integer, key: :tf_product_id]},
      ...
      "DW.CC_CONTRACTS_PRODUCT_FEATURES" => [
        ...
        {"PART", [type: :integer]},
        {"PRD_FEATURE_ID", [type: :integer, key: :tf_prd_feature_id]},
        {"RESELLER_ID", [type: :integer]},
        {"SOURCE", [type: :text]},
        {"SOURCE_ID", [type: :text]},
        {"START_DT", [type: :date]},
  ...
  defp party_id_tables(),
    do: %{
      ...
      "DW.CC_HANDSET_TYPE_PROPERTIES" => [
        {"HANDSET_TYPE_ID", [type: :integer, key: :tf_handset_type_id]},
        {"HST_PROPERTY_ID", [type: :integer, key: :tf_handset_property_id]},
        {"HST_PROPERTY_VALUE", [type: :text]},
        {"HST_PROPERTY_VALUE_ID", [type: :integer, key: :tf_handset_property_value_id]},
        {"SA_DELETE_DATE", [type: :date]},
        {"SA_END_DATE", [type: :date]},
        {"SA_REFERENCE_DATE", [type: :date]},
        {"SA_ROWID", [type: :text]},
      ...
      "DW.CC_HANDSET_TYPE" => [
        ...
        {"VENDOR_ID", [type: :integer, key: :tf_vendor_id]},
