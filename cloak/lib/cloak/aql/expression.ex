defmodule Cloak.Aql.Expression do
  ...
  defstruct [
    ...
    value: nil, function: nil, function_args: [], aggregate?: false
  ]
  ...
  def function?(%__MODULE__{function: fun}) when fun != nil, do: true
  def function?(_), do: false

  @doc "Returns true if the given term represents a database function call."
  @spec aggregate_function?(Cloak.Aql.Parser.column | t) :: boolean
  def aggregate_function?(column), do: function?(column) && column.aggregate?
