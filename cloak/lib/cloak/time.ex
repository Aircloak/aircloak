defmodule Cloak.Time do
  ...
  @doc """
  Returns the minimum legal year. It is set to 1900. Dates below this are not very useful and
  are not supported across many databases.
  """
  @spec year_lower_bound() :: pos_integer()
  def year_lower_bound(), do: 1900

  @doc """
  Returns the maximum legal year. It is set to 9999. Dates above this are broken in Elixir (for example they
  inspect incorrectly) and many databases, and are not guaranteed to work according to ISO-8601.
  """
  @spec year_upper_bound() :: pos_integer()
  def year_upper_bound(), do: 9999
