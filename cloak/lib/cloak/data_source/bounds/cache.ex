defmodule Cloak.DataSource.Bounds.Cache do
  ...
  def lookup(cache_ref \\ __MODULE__, data_source, table, column_name),
    do: Cache.lookup(cache_ref, data_source, table, column_name)
  ...
  def value(cache_ref \\ __MODULE__, data_source, table, column_name),
    do: Cache.value(cache_ref, data_source, table, column_name)
