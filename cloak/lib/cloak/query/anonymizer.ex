defmodule Cloak.Query.Anonymizer do
  ...
  @doc "Same as `sufficient_count?(anonymizer, Enum.count(values))`"
  @spec sufficiently_large?(t, Enumerable.t) :: {boolean, t}
  def sufficiently_large?(anonymizer, values), do: sufficient_count?(anonymizer, Enum.count(values))
  ...
  """
  @spec sufficient_count?(t, non_neg_integer) :: {boolean, t}
  def sufficient_count?(anonymizer, real_count) do
