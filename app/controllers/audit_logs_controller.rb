class AuditLogsController < ApplicationController
  ...
  def index
    ...
    @latest_entries = AuditLog.paginate(page: params[:page], per_page: 30).
  ...
  def cloak
    ...
    @entries = @cloak.audit_logs.
      paginate(page: params[:page], per_page: 30).order(log_id: :desc)
  end

  def cluster
    @cluster = Cluster.find params["cluster_id"]
    @entries = AuditLog.paginate(page: params[:page], per_page: 30).
